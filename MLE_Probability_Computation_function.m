#This function computes the conditional probability of the last word in a n-gram with respect to the rest of the words in that n-gram througth the Maximum Likelihood Estimation (MLE) method. This receives the n-gram in String, two structs called Statistics1 and Statistics2 that contain all the statistics learned from a training corpus for the n-grams and for the (n-1)-grams respectivelly, as the inputs and returns the conditional probability of the last word of n-gram as the output.
...
function Cond_Probability = MLE_Probability_Computation_function(String,Statistics1,Statistics2)
...
Cond_Probability= C1/C2;					#The conditional probability for the MLE method.
